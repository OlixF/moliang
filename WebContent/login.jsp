...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			...
			<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="user?action=login" method="post">
			<!-- <form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="#" method="post"> -->				
		      ...
		      <div class="text-center">
		      	<a href="register.jsp" class="templatemo-create-new">注册新用户 <i class="fa fa-arrow-circle-o-right"></i></a>	
		      </div>
		</div>
	</div>
</body>
